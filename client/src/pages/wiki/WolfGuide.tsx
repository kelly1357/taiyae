      ...
      <div className="px-6 py-6">
        ...
        <div className="flex flex-col lg:flex-row gap-6">
          ...
          <div className="mt-8 pt-4 border-t border-gray-300">
            <p className="text-xs mb-2"><strong>Joining Guide:</strong></p>
            <p className="text-xs">
              ← Back: <Link to="/wiki/setting-overview" className="text-[#2f3a2f] hover:underline">Setting Overview</Link>
              {' | '}
              Next: <span className="font-bold">Is Horizon Right for You?</span> →
            </p>
          </div>
